...
using EIS.Shared.RabbitMQ.Exceptions;
using EIS.Shared.RabbitMQ.Internals;
using Humanizer;
...
using IMessageHandler = EIS.Shared.RabbitMQ.Internals.IMessageHandler;
using MessageHandler = EIS.Shared.RabbitMQ.Internals.MessageHandler;
